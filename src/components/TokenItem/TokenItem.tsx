    ...
    return (
        <T.Wrapper onClick={handleShowDescription}>
            <T.Inner>
                ...
                <T.PriceWrapper>
                    <T.Price>{item.price} $</T.Price>
                    <ColorNumbers data={priceChange} />
                </T.PriceWrapper>
                <T.Volume>
                    <p>{numberWithSpaces(item.volume)} $</p>
                    <T.VolChange>{item.volumeChangePercentage}%</T.VolChange>
                </T.Volume>
                <T.Volume>
                    <p>{numberWithSpaces(item.tvl)} $</p> 
                    <T.VolChange>{item.tvlChangePercentage}%</T.VolChange>
                </T.Volume>
                <T.Users>
